<div class='login'>
  <div class='login-box'>
    ...
    <div class='login-right-card shadow'>
      <form action="<?php echo FRONT_ROOT ?>Auth/AdminLogin" method="post">
        <p>Login</p>
        <input type='text' class="form-control" name='email' placeholder="Your Email" formControlName="email">
        <hr>
        <input type='password' name='password' value='' placeholder="Your Password" class="form-control" formControlName="password">
        <hr>
